...
set_property PACKAGE_PIN K2 [get_ports {radio_pins[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {radio_pins[3]}]
...
set_property PACKAGE_PIN H4 [get_ports {radio_miso}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {radio_miso}]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
set_property PACKAGE_PIN H1 [get_ports {radio_pins[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {radio_pins[0]}]
##Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = JD3
set_property PACKAGE_PIN G1 [get_ports {radio_pins[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {radio_pins[1]}]
##Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = JD4
set_property PACKAGE_PIN G3 [get_ports {radio_pins[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {radio_pins[2]}]
